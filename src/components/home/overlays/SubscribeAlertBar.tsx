...
const SubscribeAlertBar = () => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="text-white px-2 py-1 font-extrabold rounded-xl hover:text-red-500 bg-red-500 hover:bg-transparent border-2 border-solid border-red-500 transition-all ease-linear"
      >
        Subscribe
      </button>
      <div
        className="relative float-right top-2 cursor-pointer text-xl leading-3 font-extrabold rounded-xl p-2  hover:text-white"
