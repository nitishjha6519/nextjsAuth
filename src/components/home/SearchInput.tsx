...
const SearchInput = () => {
  ...
  return (
    <div className="m-4 relative">
      <input
        type="text"
        className="placeholder-white w-[min(400px,80vw)] bg-color-bg bg-[url('/assets/search-white.png')] bg-no-repeat bg-[0.75em_center] bg-[length:1em] ps-14 py-3 pe-4 text-2xl font-bold text-black outline-none border-b border-solid border-white rounded-full focus:shadow-[0_0_0_5px_rgba(255,75,66,0.5)]"
